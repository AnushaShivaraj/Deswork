		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#VASPPManage_Project-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"VASPPManage_Project-display": {
								"semanticObject": "VASPPManage_Project",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=VASPP.Manage_Project",
									"url": sap.ui.require.toUrl("VASPP/Manage_Project")
								}
							}
						}
					}
