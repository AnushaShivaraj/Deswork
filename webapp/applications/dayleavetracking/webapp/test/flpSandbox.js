		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vasppdayleavetracking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vasppdayleavetracking-display": {
								"semanticObject": "vasppdayleavetracking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.dayleavetracking",
									"url": sap.ui.require.toUrl("vaspp/dayleavetracking")
								}
							}
						}
					}
