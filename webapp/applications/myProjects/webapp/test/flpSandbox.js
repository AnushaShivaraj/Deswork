		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "project100",
									"targetURL": "#VASPPproject100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"VASPPproject100-display": {
								"semanticObject": "VASPPproject100",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=VASPP.project100",
									"url": sap.ui.require.toUrl("VASPP/project100")
								}
							}
						}
					}
