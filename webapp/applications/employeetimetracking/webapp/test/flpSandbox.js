		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vasppemployeetimetracking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vasppemployeetimetracking-display": {
								"semanticObject": "vasppemployeetimetracking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.employeetimetracking",
									"url": sap.ui.require.toUrl("vaspp/employeetimetracking")
								}
							}
						}
					}
