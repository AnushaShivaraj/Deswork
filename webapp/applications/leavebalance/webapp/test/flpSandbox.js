		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vasppleavebalance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vasppleavebalance-display": {
								"semanticObject": "vasppleavebalance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.leavebalance",
									"url": sap.ui.require.toUrl("vaspp/leavebalance")
								}
							}
						}
					}
