		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "mypublicholidays",
									"targetURL": "#vasppmypublicholidays-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vasppmypublicholidays-display": {
								"semanticObject": "vasppmypublicholidays",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.mypublicholidays",
									"url": sap.ui.require.toUrl("vaspp/mypublicholidays")
								}
							}
						}
					}
