		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vasppmyprofile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vasppmyprofile-display": {
								"semanticObject": "vasppmyprofile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.myprofile",
									"url": sap.ui.require.toUrl("vaspp/myprofile")
								}
							}
						}
					}
