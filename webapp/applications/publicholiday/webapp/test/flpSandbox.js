		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vaspppublicholiday-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vaspppublicholiday-display": {
								"semanticObject": "vaspppublicholiday",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.publicholiday",
									"url": sap.ui.require.toUrl("vaspp/publicholiday")
								}
							}
						}
					}
