		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vaspptimetracking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vaspptimetracking-display": {
								"semanticObject": "vaspptimetracking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.timetracking",
									"url": sap.ui.require.toUrl("vaspp/timetracking")
								}
							}
						}
					}
